...
#Profile:Sony VAIO Duo 13
	; Literally the first byte of the string.
	FirstByte=0x03

	; Im guessing this is the size of the actual string
	RawDataSize=27
	RawDataOffset=3

	; This is one set of variables im sure of - the max X and Y hex values.
	; These aren't perfect, and had to be played with... :/
	MaxX=0x2904        
	MaxY=0x1c52
	...
	; This is definitely needed, but I dont know
	OffsetTouchId=1
	
	; The offset for locating the touch on/off hex value.
	OffsetStat=0

	;The location of the X and Y values in the hex string.
	OffsetX=3
	OffsetY=7


#Profile:Microsoft Surface Pro 3
	FirstByte=0x03
	RawDataSize=27
	RawDataOffset=3
	MaxX=0x2580
